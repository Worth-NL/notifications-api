...
from notifications_utils.recipient_validation.phone_number import is_nl_phone_number, use_numeric_sender
...
def get_sms_reply_to_for_notify_service(recipient, template):
    if not is_nl_phone_number(recipient) and use_numeric_sender(recipient):
